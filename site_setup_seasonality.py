...
exp_label = 'Nort_nseasonality'                                                          # added label for outputs
burnin_id = '2466edc2-6909-451d-b467-27f31f8bdb2b'                                                        # Single-Node Ex. hab_sweep_1 (site 'sapone' with climate from 2010-2019)
pickup_id = ''                                                          # 
...
report_years = 4                                                        # Limit to final n years of pickup in non-InsetChart reports of pickup
##### Climate ###########################################################
######################################################## Date range #####
...
def analyze_pickup(pickup_id=pickup_id, output_folder=output_folder,                               #
    ...
    with Platform('SLURM_LOCAL',job_directory=jdir) as platform:                                   # 
        analyzer_set = []                                                                          #
        if(InsetChart == True):
          from analyzers.habitat_analyzer import InsetChartAnalyzer   
        ...
        if(MonthlyReport == True):
          from analyzers.habitat_analyzer import MonthlyAnalyzer  # Analyze Monthly MalariaSummaryReport
